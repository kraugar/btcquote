...
var BTCQuote = function () {
	...
	self._template = [
		'<style>',
			...
			'.btc-box {height: 71px; width: 208px;}',
		...
		'<div class="btc-box" style="font-family: Arial; position: relative; overflow:hidden; background-color: #DFE0E2; background-image: url(' + BACKGROUND_GRADIENT + '); background-repeat: repeat-x; line-height: 1; border-radius: 4px; border: 2px solid #D6D4D7;">',
			'<div class="btc-is-loading" id="btc-slider">',
				'<div class="btc-box">',
					...
					'<span id="btc-last-wrapper" style="position: relative; z-index: 2; font-weight: bold; font-size: 30px; float: right; margin: 6px 10px 0px 0px; height: 32px; width: 140px; text-align: right;"><span style="position: relative; top: 2px; paddng-right: 2px; font-size: 24px;">$</span><span class="odometer" id="btc-last-field"></span></span><br />',
					'<span class="btc-hides" style="float: right; margin-right: 10px; height: 14px; color: #999; font-size: 10px; ">',
						'<span style="float: left;">Bid: <b><span id="btc-bid-field"></span></b></span>',
						'<span style="float: left; margin-left: 6px;">Ask: <b><span id="btc-ask-field"></span></b></span><br />',
					'</span>',
